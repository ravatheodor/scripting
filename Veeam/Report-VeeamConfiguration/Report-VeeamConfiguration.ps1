<#
    ...
    Report-GetConfiguration.ps1 is a tool for collecting VBR cofiguration and generating word documentation. 
...
"@
    ...
    Do { 
        ...
        "7" {   # Backup sessions 
                ...
                Write-Host "... getting backup sessions for last $($HoursToCheck) hours "
        ...
        "8" {   # Replica sessions 
                ...
                $logFile = $logFilePath + $logFileName
                Write-Host "... getting replica sessions for last $($HoursToCheck) hours"
